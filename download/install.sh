...
cp "$GARDEN_DIR/启动花园.command" "$HOME/Desktop/AgentGarden Code.command" 2>/dev/null || true
chmod +x "$HOME/Desktop/AgentGarden Code.command" 2>/dev/null || true
